...
{
       0,    44,    44,    47,    48,    51,    60,    67,    74,    79,
      86,    93,   100,   105,   108,   111
};
#endif
...
{
       8,     9,    16,    17,    15,    16,    17,     1,    21,    10,
      18,    19,    20,     5,    24,    25,    26,     6,    22,    23,
      14,     7
};

static const yytype_int8 yycheck[] =
{
       3,     4,     7,     8,     6,     7,     8,     3,    13,    12,
       9,    10,    11,     5,    18,    19,    20,     0,    16,    17,
      10,     3
};
...
{
       0,     3,    15,    16,    17,     5,     0,    17,     3,     4,
      12,    18,    19,    20,    18,     6,     7,     8,     9,    10,
      11,    13,    19,    19,    20,    20,    20
};
...
#line 51 "parser.y"
                            {
                char buf[INSTR_LEN];
                snprintf(buf, sizeof(buf), "MOV %s, %s", (yyvsp[-3].str), (yyvsp[-1].str));
                emit(buf);
                free((yyvsp[-3].str));
                free((yyvsp[-1].str));
          }
...
#line 60 "parser.y"
                ...
                (yyval.str) = newTemp();
                char buf[INSTR_LEN];
                snprintf(buf, sizeof(buf), "ADD %s, %s, %s", (yyval.str), (yyvsp[-2].str), (yyvsp[0].str));
                emit(buf);
...
#line 67 "parser.y"
                ...
                (yyval.str) = newTemp();
                char buf[INSTR_LEN];
                snprintf(buf, sizeof(buf), "SUB %s, %s, %s", (yyval.str), (yyvsp[-2].str), (yyvsp[0].str));
                emit(buf);
                free((yyvsp[-2].str)); free((yyvsp[0].str));
          }
...
#line 79 "parser.y"
                ...
                (yyval.str) = newTemp();
                char buf[INSTR_LEN];
                snprintf(buf, sizeof(buf), "MUL %s, %s, %s", (yyval.str), (yyvsp[-2].str), (yyvsp[0].str));
                emit(buf);
                free((yyvsp[-2].str)); free((yyvsp[0].str));
          }
...
#line 86 "parser.y"
                ...
                (yyval.str) = newTemp();
                char buf[INSTR_LEN];
                snprintf(buf, sizeof(buf), "DIV %s, %s, %s", (yyval.str), (yyvsp[-2].str), (yyvsp[0].str));
                emit(buf);
                free((yyvsp[-2].str)); free((yyvsp[0].str));
          }
...
#line 93 "parser.y"
                ...
                (yyval.str) = newTemp();
                char buf[INSTR_LEN];
                snprintf(buf, sizeof(buf), "MOD %s, %s, %s", (yyval.str), (yyvsp[-2].str), (yyvsp[0].str));
                emit(buf);
                free((yyvsp[-2].str)); free((yyvsp[0].str));
          }
